...
some linear combination of known, and usually orthogonal ($\intf(x)g(x)w(x)=0$), basis functions
...
To approximate any function we'd need to feed in some polynomial function `g(x, n)`  
...
An alternative representation of Chebyshev polynomials that is more compact for coding is
