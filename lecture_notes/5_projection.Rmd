...
The approximation won't be as good, all else equal
...
Just like you might expect, we effectively have a different value function approximant over the continuous states for each value of $S_d$
...
The computational complexity here grows exponentially: $\text{total # point} = (\text{points per  state})^{\text{# states}}$
