...
# Now lets try simulating: not perfect!
...
We use some equilibrium condition, typically an Euler equation, and put it into a fixed point form

-- 

We then iteration on this fixed point similar to function iteration like we learned before