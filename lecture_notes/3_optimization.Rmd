...
maximizing a function (e.g. profit) subject to some constraint (e.g. price floors)
...
the most commonly used one is **Nelder-Mead (NM)**
...
Interior-point is usually the default in constrained optimization solvers (low memory usage, fast),  
but try other algorithms and see if the solution generally remains the same
